# Deploy Versao Simples
Write-Host "Deploy da versao simples da Area do Cliente" -ForegroundColor Green
...
Write-Host "Enviando versao simples da Area do Cliente..." -ForegroundColor Yellow

# Upload versao simples
Upload-File "area-cliente-simples.html" "/area-cliente-app.html"

Write-Host "Versao simples enviada!" -ForegroundColor Green
