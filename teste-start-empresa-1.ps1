# Teste webhook start com empresa_id = 1
...
$payload = @{
    ...
    logged_user = @{
        ...
        empresa_id = 1  # MUDANCA: empresa_id = 1 para match com o lead
    }
    agente_id = 82
    perfil_id = 2
...
Write-Host "TESTE WEBHOOK START - EMPRESA_ID = 1" -ForegroundColor Yellow
