...
Write-Host "Deploy da versao completa da Area do Cliente" -ForegroundColor Green
...
Write-Host "Enviando versao completa da Area do Cliente..." -ForegroundColor Yellow

# Upload versao completa
Upload-File "area-cliente-completa.html" "/area-cliente-app.html"

Write-Host "Versao completa enviada!" -ForegroundColor Green
Write-Host "Agora a aplicacao tem dashboard funcional!" -ForegroundColor Cyan
